...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	РегистрационныеДанные = ДополнительныеОтчетыИОбработки.СведенияОВнешнейОбработке("1.0.1.5");
	...
	ДобавитьКоманду(ТаблицаКоманд, "Открыть форму настроек обмена с Планфикс", "ОктрытьФорму", "ОткрытиеФормы");
...
Процедура ВыполнитьКоманду(ИдентификаторКоманды, ПараметрыВыполненияКоманды = Неопределено) Экспорт
	// // Отладка
	//Адрес = "D:\planfix\1c\PlanFix_1Cv8.epf";
	//Обр = ВнешниеОбработки.Создать(Адрес, БезопасныйРежим());
	//Обр.ВыполнитьКоманду(ИдентификаторКоманды, ОбъектыНазначения);
	//Возврат;
	//// Отладка
