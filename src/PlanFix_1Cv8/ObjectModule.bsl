...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	РегистрационныеДанные.Вставить("Версия", "1.3.0");
		...
		Если  Поле.Ключ = "email" Тогда
			...
			Если МассивИскомыхСтрок.Количество() <> 0 Тогда
				Если МассивИскомыхСтрок[0].Представление <> СокрЛП(Поле.Значение) Тогда
					...
					МассивИскомыхСтрок[0].Значение = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(МассивИскомыхСтрок[0].Представление, МассивИскомыхСтрок[0].Тип);
					МассивИскомыхСтрок[0].ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияВXML(МассивИскомыхСтрок[0].Значение);
				КонецЕсли;
			Иначе 
