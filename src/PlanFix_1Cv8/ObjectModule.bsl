...
Функция ТестПодключения()Экспорт
	...
	HTTPЗапрос = Новый HTTPЗапрос(СтруктураURI.ПутьНаСервере+"?access_token=" + НастройкиПодключения.ТокенАвторизации); 
	HTTPЗапрос.Заголовки.Вставить("Content-type", "application/x-www-form-urlencoded");
	//HTTPЗапрос.УстановитьТелоИзСтроки("access_token=" + НастройкиПодключения.ТокенАвторизации, КодировкаТекста.UTF8, ИспользованиеByteOrderMark.НеИспользовать);
