...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	РегистрационныеДанные = ДополнительныеОтчетыИОбработки.СведенияОВнешнейОбработке("1.0.1.6");

	РегистрационныеДанные.Вставить("Наименование", "Модуль интеграции 1С:Предприятие 8 и Planfix");
	РегистрационныеДанные.Вставить("БезопасныйРежим", Ложь);
	РегистрационныеДанные.Вставить("Версия", "1.6");
...
#Область БП
	...
	Если КолонкаТЗ.Имя = "ЮридическоеФизическоеЛицо" Тогда
		ЗаписьJSON.ЗаписатьИмяСвойства("isCompany");
