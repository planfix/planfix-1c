...
Функция  УстановитьЗначениеСвойствНовыйПартнер(НастройкаСопоставленияДанных, НовыйПартнер, КонтактJSON)
	...
	ИсползоватПартнеровКакКонтрагентовУстановитьЗначениеКонтрагента(НовыйПартнер.Ссылка);	
...
Процедура УстановитьЗначениеСвойствТекущийПартнер(НастройкаСопоставленияДанных, Партнер, КонтактJSON)
	...
	ИсползоватПартнеровКакКонтрагентовУстановитьЗначениеКонтрагента(Партнер.Ссылка);	
...
Процедура ИсползоватПартнеровКакКонтрагентовУстановитьЗначениеКонтрагента(ПартнерСсылка)
