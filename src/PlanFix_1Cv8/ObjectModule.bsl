...
Функция СофрмироватьJSON(ИдентификаторИБ, ТаблицаВыгружаемыхДанных, ИмяОбъектаПланфикс, НастройкаСопоставленияДанных) Экспорт
...
Функция ПолучитьСлужебныеДанные() Экспорт
	...
	Если Метаданные.Имя = "УправлениеТорговлей" 
		...
		ИЛИ Метаданные.Имя = "КомплекснаяАвтоматизация" Тогда
